...
public class SwaggerConfig {
 public static final ApiInfo API_INFO=new ApiInfo("Training spring", "Testing swagger", "1.0", "Apache 2.0", "Bangalore", "some licence info", "http://springtraining.com/licence");
